                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="action_block">
                                                    <a  style="cursor: pointer;" class="btn btn-lg btn-primary notify_model" data_list_id="{{ $fir_data['id'] }}" data_user_id="{{ $fir_data['user']['id']}}"> <i class="fa fa-bell-o" aria-hidden="true"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="my_message_form" method="post" action="{{ url('send-message-to-user') }}">
                                                                ...
                                                                <input type="hidden" name="type" value="FirstDummy">
                                                                @csrf
                                                            </form>
                                                        </div>
                                                    </div>

        ...
        <div class="card-body">
            <div class="row no-gutters">
                ...
                <div class="col-6 align-items-center shadow-none text-center">
                    <a href="employees.html" class="text-dark p-4 second-slider-btn ctm-border-right ctm-border-top"><span class="lnr lnr-users pr-0 pb-lg-2 font-23"></span><span class="">Job Listing Websites</span></a>
                </div>
                <div class="col-6 align-items-center shadow-none text-center">

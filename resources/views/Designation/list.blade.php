                                ...
                                <table class="table custom-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><i class="fa fa-fw fa-arrow-up sortCick" data-value='asc' data-name='titleSort' data-id='titleSort' data-submit='designation_submit'></i>Name<i class="fa fa-fw fa-arrow-down sortCick" data-value='desc' data-name='titleSort' data-id='titleSort' data-submit='designation_submit'></i></th>
